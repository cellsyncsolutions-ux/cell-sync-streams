...
export const translations = {
  en: {
    ...
    nav_research_disclaimer:
      "Products are supplied solely for legitimate laboratory and research applications. They are not intended for human consumption, administration, diagnosis, treatment, prevention, or mitigation of disease.",
    ...
    about_bullet_2: "All products are for research use only. We cannot provide instructions or advice on any form of use.",
    about_bullet_3: "All products are for research and testing only. We cannot provide guidance on any form of use.",
  ...
  es: {
    ...
    nav_research_disclaimer:
      "Los productos se suministran exclusivamente para aplicaciones legítimas de laboratorio e investigación. No están destinados al consumo humano, administración, diagnóstico, tratamiento, prevención o mitigación de enfermedades.",
    ...
    about_bullet_2: "Todos los productos son exclusivamente para investigación. No podemos proporcionar instrucciones ni consejos sobre cualquier forma de uso.",
    about_bullet_3: "Todos los productos son únicamente para investigación y pruebas. No podemos brindar orientación sobre cualquier forma de uso.",
    ...
    about_mission_body:
      "Empoderar a los laboratorios con péptidos fabricados bajo cGMP, probados de forma independiente y respaldados por un soporte receptivo.",
