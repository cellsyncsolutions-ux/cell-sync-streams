...
export const products: Product[] = [
  ...
  { id: "bpc-157", name: "BPC-157", category: "Peptides", price: 20, priceRange: [20, 30], image: bpc157Vial,
    sale: true,
    variants: [{ label: "5mg", price: 20, originalPrice: 22 }, { label: "10mg", price: 30, originalPrice: 33 }] },
  ...
  { id: "tb-500", name: "TB-500", category: "Peptides", price: 25, priceRange: [25, 65], image: tb500Vial,
    sale: true,
    variants: [{ label: "5mg", price: 25, originalPrice: 28 }, { label: "10mg", price: 65, originalPrice: 73, outOfStock: true }] },
  ...
  { id: "ghk-cu", name: "GHK-Cu", category: "Peptides", price: 20, priceRange: [20, 35], image: ghkCuVial,
    sale: true,
    variants: [{ label: "50mg", price: 20, originalPrice: 22 }, { label: "100mg", price: 35, originalPrice: 39 }] },
